...
import { CharacterSheetProps, ICharacter } from "./Types";
            ...
            <Grid className={classes.gridItem} item md={4} >
              <Grid container spacing={2}>
                ...
                <Grid item md={8}>
                  ...
                  <SavingThrows {...charProps} />
                  <Skills  {...charProps} />
                </Grid>
              </Grid>

              <InputLabelGroup label="Passive Perception" onChange={onPassivePerceptionChange} value={formatModifier(character.passivePerception)} />
